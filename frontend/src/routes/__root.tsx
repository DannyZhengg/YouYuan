...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "YouYuan — Chinese drama recommendations" },
      {
        name: "description",
        content: "Discover Chinese dramas by meaning, mood and emotion.",
      },
      { property: "og:title", content: "YouYuan — Chinese drama recommendations" },
      {
